...
- What is the scope? (UI only? Redux state? Navigation? API?)
...
```bash
# Find components
Glob: "src/components-next/**/*{name}*.tsx"

# Find screens
Glob: "src/screens/**/*{name}*.tsx"

# Find Redux slices
Glob: "src/store/**/*{name}*.ts"
...
| Platform-specific issues | Document separately for iOS/Android |
...
|-------|---------|-------------|
| [/dev-feature](../dev-feature/SKILL.md) | Full feature workflow | After research, for implementation |
| [/review-code](../review-code/SKILL.md) | Code review | After implementation |
