...
### Purpose
Configure a complete Android development environment for building and running the Chatwoot Mobile App on Android emulators and physical devices. This guide covers JDK installation, Android Studio setup, SDK configuration, emulator creation, and environment variables.
...
| [/setup-ios](../setup-ios/SKILL.md) | iOS environment | Setting up iOS development |
...
| [/deploy-app](../deploy-app/SKILL.md) | App deployment | Building for Play Store |
