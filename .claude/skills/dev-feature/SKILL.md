...
|-------|---------|-------------|
| [/design-research](../design-research/SKILL.md) | Research and design | Phase 2-3: Research and Design |
| [/review-code](../review-code/SKILL.md) | Code review | Phase 6: Validation |
| [/test-mobile](../test-mobile/SKILL.md) | Mobile testing | Phase 6: Validation |
| [/git-pr](../git-pr/SKILL.md) | Create pull requests | After feature complete |
