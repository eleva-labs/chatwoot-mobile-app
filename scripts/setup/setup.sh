...
# Full setup has scripts 00-09 (10 scripts total)
TOTAL_STEPS=10
...
# Platform-specific scripts (Phase 3)
run_script "05" "install_ios_deps" "Installing iOS dependencies..." "ios"
run_script "06" "install_android_deps" "Installing Android dependencies..." "android"

# Project setup scripts (Phase 4)
run_script "07" "install_project_deps" "Installing project dependencies..." "all"
run_script "08" "setup_env" "Setting up environment..." "all"
run_script "09" "verify_setup" "Verifying setup..." "all"
