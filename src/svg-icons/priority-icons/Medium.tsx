...
/**
 * MediumIcon - Custom priority indicator (2 ascending bars)
 *
 * @migrated 2026-03-02 (Cycle 2 MEGA BATCH - theme support added)
 * @custom Unique 2-bar design - no Lucide equivalent
 */
export const MediumIcon = ({ color, size = 20, ...props }: IconProps) => {
  const { colors } = useThemeColors();
  const activeColor = color || colors.amber[9];
